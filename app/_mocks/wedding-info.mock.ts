...
export const mockWeddingInfo: WeddingInfo = {
  ...
  coverImage: {
    day: { src: 'https://fastly.picsum.photos/id/13/2500/1667.jpg?hmac=SoX9UoHhN8HyklRA4A3vcCWJMVtiBXUg0W4ljWTor7s', position: 'center' },
    night: { src: 'https://fastly.picsum.photos/id/152/3888/2592.jpg?hmac=M1xv1MzO9xjf5-tz1hGR9bQpNt973ANkqfEVDW0-WYU', position: 'center' },
  },
  galleryImages: [
