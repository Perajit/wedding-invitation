...
const InvitationContainer: FC<SharedPropsWithWeddingInfo> = ({ weddingInfo }) => {
  ...
  return weddingInfo ? (
    ...
    >
      ...
      <InfoSection weddingInfo={weddingInfo} className="px-4 pt-12 py-6" />
      <GallerySection weddingInfo={weddingInfo} className="px-4 py-10" />
      <LocationSection weddingInfo={weddingInfo} className="h-dvh px-4 py-10" />
